        ...
        <>
            <main className="min-h-full flex flex-col p-5  justify-center items-center dark:bg-dpurple bg-[url('/MessageSvg.svg')]">
                ...
                <div className="full flex flex-col justify-center items-center mt-9">
                    <h1 className='text-3xl p-3 text-center mt-2 font-bold'>PRINCIPALS MESSAGES</h1>
                    <AboutMessageCard
                        img="/Mgt/principal.png"
                        heading="Mrs. Arun Agrawal, Principal (Pratibha Global School, Bagli)"
                        content="Dear Pratibha Global School Community,
                        As we commence a new academic year in the vibrant city of Bagli, Madhya Pradesh, I extend a heartfelt welcome to our esteemed students, dedicated parents, and passionate educators. At Pratibha Global School, we take pride in providing a holistic educational experience catering to students across diverse stages from the formative years of Pre-Primary to the pinnacle of Higher-Secondary education.
