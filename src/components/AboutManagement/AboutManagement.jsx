            ...
            <div className='w-full mt-10 flex flex-col justify-center items-center'>
                ...
                <div className='w-full md:w-11/12 lg:w-10/12  mt-4 p-4'>
                    <div className='w-full grid lg:grid-cols-5 md:grid-cols-5 md:gap-5  lg:gap-5 grid-cols-1 '>
                        <AboutManagementCard img="/Mgt/founder.png" name="Late Shri Suresh Kumar Chouksey" post="Founder SKC LNCT Group Of Colleges" link="/about/founders-message" />
                        ...
                        <AboutManagementCard img="/Mgt/principal.png" name="Mrs. Arun Agrawal" post="Principal (Pratibha Global School, Bagli)" link="/about/principals-message" />

                    </div>
                </div>
                <button className='bg-white border-2 border-tred p-3 mt-5 rounded-md hover:bg-tred' onClick={() => { router.push('/about/school-staff') }}>View Our Staff</button>
