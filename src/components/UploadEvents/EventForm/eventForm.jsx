...
import EventForm from "@/components/EventForm/EventForm"; // Assuming you have an EventForm component
  ...
  const handleChange = ({ target }) => {
    ...
    if (name === "thumbNail") {
      ...
      if (!value && type !== 'checkbox') {
        setValidationErrors((prevErrors) => ({ ...prevErrors, [name]: 'This field is required' }));
  ...
  return (
    <>
      <div className='flex flex-col w-full justify-center items-center bg-[url("/MessageSvg.svg")]'>
        <h1 className="text-center mx-auto w-full my-3 text-4xl font-bold text-tred ">
          Event Details Form
        </h1>
        <div
