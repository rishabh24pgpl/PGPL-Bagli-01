...
const AdmissionForm = () => {
   ...
   '/students/_DSC1038.JPG'
    ...
    const buttonData = [
        { name: 'Get in Touch', gradient: 'from-purple-500 via-purple-600 to-purple-700', textColor: 'text-white' },
        { name: 'Campus Visit', gradient: 'from-red-200 via-red-300 to-yellow-200', textColor: 'text-white' },
        { name: 'Application Form', gradient: 'from-purple-500 via-purple-600 to-purple-700', textColor: 'text-white' },
        { name: 'Submit Documents', gradient: 'from-purple-500 via-purple-600 to-purple-700', textColor: 'text-white' },
        { name: 'Receive Enrollment No', gradient: 'from-purple-500 via-purple-600 to-purple-700', textColor: 'text-white' },
        { name: 'Yay! center learning', gradient: 'from-purple-500 via-purple-600 to-purple-700', textColor: 'text-white' },
    ];
                    ...
                    <div className='flex flex-col md:flex-row md:justify-around items-center bg-cover'>
                        ...
                        <div className='flex flex-col justify-center items-center mt-5 md:mt-0 max-w-3xl'>
                            <h1 className="mb-4 text-center text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl">
                                ...
                                <span> Towards<br></br> Happy Learning.</span>

                            </h1>
                            <p className="text-lg my-5 font-normal text-gray-500 lg:text-xl dark:text-gray-400">
                                Here, learning is a joy ride!.
                            </p>
                            <button type="button" className="text-white  hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-pink-300 dark:focus:ring-pink-200 shadow-lg shadow-red-100 dark:shadow-lg dark:shadow-red-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center"  style={{background:'#ff0000'}}>
                                About Us
                            </button>
                        </div>
                    </div>
                    ...
                    <div className='w-full bg-white py-10 bg-cover ' style={{ backgroundImage: "url('/Rect Light.svg')" }}>
                        <div className='md:max-w-[1480px] m-auto grid md:grid-cols-2 max-w-[600px]  px-4 md:px-0 mx-auto'>
                            ...
                            <div className='flex flex-col justify-center gap-4 text-center'>
                                <p className='py-2 text-2xl text-[#c80d0d] font-medium'>Admission</p>
                                <h1 className='md:leading-[72px] py-2 md:text-6xl text-4xl font-semibold'>Join Our Family  <span className='text-[#c80d0d]'>of Young Learners </span>
                            ...
                            <div className='relative'>
                                <Image alt="image" src={images[currentSlide]} width={700} height={300} className='md:order-last order-first rounded-full max-h-full' />
                            </div>
                            ...
                            <div className="p-1.5 min-w-full inline-block align-middle">
                                <div className="overflow-hidden shadow-xl  rounded-lg">
                                    <table className="min-w-full divide-y divide-gray-200  dark:divide-gray-700 ">
                                        <thead>
                                            <tr>
                                                <th scope="col" className="bg-red-400 px-6 py-3 text-center text-xs font-bold text-gray-100 uppercase">Programme</th>
                                                <th scope="col" className="bg-red-400 px-6 py-3 text-center text-xs font-bold text-gray-100 uppercase">Age Group</th>
                                                <th scope="col" className="bg-red-400 px-6 py-3 text-center text-xs font-bold text-gray-100 uppercase">Annual Tution</th>
                                            </tr>
                                        </thead>
                            ...
                            <div className="p-1.5 min-w-full inline-block align-middle">
                                <div className="overflow-hidden   shadow-xl rounded-lg">
                                    <table className="min-w-full divide-y divide-gray-200  dark:divide-gray-700">
                                        <thead>
                                            <tr>
                                                <th scope="col" className="bg-red-400 px-6 py-3 text-center text-3xl font-medium text-gray-100 uppercase ">Additional Services</th>

                                                <th scope="col" className="bg-red-400 px-6 py-3 text-center text-3xl font-medium text-gray-100 uppercase "></th>
                                            </tr>
                                        </thead>
