...
const Footer = () => {
  ...
  return (
    <footer className={path.includes('admin')?"h-full ml-14 mt-12 mb-10 md:ml-64": ""}>
      {/* <BackgroundLayer/> */}
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="lg:flex lg:items-start lg:gap-1 ">
          <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16 ">
            ...
            <div className="col-span-2 sm:col-span-1">
              ...
              <ul className="mt-6 space-y-4 text-sm">
                ...
                <li>
                  <Link
                    target="_blank"
                    href="https://pgs-bagli.vercel.app"
                    className="text-gray-700 transition hover:opacity-75"
                  >
                    PGS-Bagli
                  </Link>
            ...
            <div className="col-span-2 sm:col-span-1">
              <p className="font-medium text-gray-900">Carrer</p>
        ...
        <div className="mt-8 border-t border-gray-100 pt-8">
          <div className="sm:flex sm:justify-between">
            <p className="text-xs text-gray-500">
              &copy; {year} PGPL. All rights reserved.
            </p>
