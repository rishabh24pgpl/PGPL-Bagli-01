...
const EventDetail = ({ eventData }) => {
  ...
  return (
    <>
      ...
      >
        <h1 class="text-5xl text-red-600 font-extrabold dark:text-white text-center p-5">
          Event
      ...
      <div className="w-10/12 flex justify-center items-center mx-auto">
        ...
        <main
          className=" w-1/2 mx-auto  h-96 flex flex-col justify-center  p-5  bg-cover bg-center border-2 border-tred"
      ...
      <section class="flex  items-center justify-center">
        <div
          ...
          style={{ backgroundImage: "url('/MessageSvg.svg')" }}
        >
          <h1 className="w-full mx-auto  text-center text-5xl font-bold p-4 text-tred">
            Event Details
          </h1>
