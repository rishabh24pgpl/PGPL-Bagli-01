...
const EventFormParticular = () => {
  ...
  const fields = [
    ...
    { name: 'floating_repeat_password', label: 'Confirm password', type: 'password' },
    { name: 'floating_first_name', label: 'First name', type: 'text' },
    { name: 'floating_last_name', label: 'Last name', type: 'text' },
    { name: 'floating_phone', label: 'Phone number (123-456-7890)', type: 'tel', pattern: '[0-9]{3}-[0-9]{3}-[0-9]{4}' },
