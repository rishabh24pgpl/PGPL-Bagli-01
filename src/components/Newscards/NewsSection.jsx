  ...
  return (
    <>
      <div className="w-full flex justify-center items-center flex-col mt-10">
        <h2 className="text-tred text-2xl font-bold ">News & Notices</h2>
        <h6 className="text-2xl text-tred font-bold ">_________________________</h6>
        <h5 className="text-tred text-2xl font-bold ">BE UPDATED ALL THE THIME</h5>
      </div>
      <div className="flex flex-col sm:flex-row w-full mt-10">
        <div className="w-full sm:w-1/2 p-1 h-[350px]">
          <h2 className="text-2xl bg-red-400 p-2 text-center">Latest Update 2023-24</h2>
          <div className="bg-bred w-full mx-auto">
            <NewsCarousel />
          </div>
        </div>
        <div className="w-full sm:w-1/2 p-1 h-[382px]">
          <h2 className="text-2xl bg-red-400 p-2 text-center">Latest News</h2>
          <div className="bg-bred h-full w-full mx-auto">
            <div className="flex mx-auto w-full h-full items-center justify-center">
              <ul ref={listRef} className="flex flex-col bg-bred p-2 w-full max-h-[350px] overflow-auto">
