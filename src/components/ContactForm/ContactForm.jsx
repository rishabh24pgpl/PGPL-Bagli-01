...
<>
{isLoading?<Loader/>:<>
<Notification msg={hasError.msg} type={hasError.type} onClick={handleForceUpdate}/>


<div className='w-full h-auto bg-white py-10 sm:bg-cover lg:bg-contain 'style={{ backgroundImage: "url('/Cloudy.svg')" }}>
        <div className='md:max-w-[1480px] m-auto grid md:grid-cols-2 max-w-[600px]  px-4 md:px-0 mx-auto'>
            ...
            <div className='flex flex-col justify-start gap-4 text-center'>
                <p className='py-2 text-2xl text-[#c80d0d] font-medium'>CONTACT US</p>
                <h1 className='md:leading-[72px] py-2 md:text-6xl text-4xl font-semibold'>Feel Free   <span className='text-[#c80d0d]'><br></br>To </span> <span  className='text-[#c80d0d]'><br></br>Connect</span>  With Us 
		...
		<div className="w-full p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
            ...
            type="number" placeholder="Phone*" />
				...
				<div className="my-2 w-1/2 lg:w-1/4">
					<button onClick={handleSubmit} className="uppercase text-sm font-bold tracking-wide hover:bg-red-700 active:bg-red-800 bg-red-400 text-gray-100 p-3 rounded-lg w-full 
			...
			<div
				className="w-full lg:-mt-96 lg:w-2/6 px-8 py-12 ml-auto bg-red-100 rounded-2xl">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-gray-400">BHAWARASALA , BEHIND ARVINDO REVATI, Sanwer Rd, Bagli, Madhya Pradesh 453555</p>
            </div>
          </div>
          ...
          <div className="flex my-4 w-2/3 lg:w-1/2">
            <a href="https://www.google.com/maps/search/pratibha+global+school+Bagli/@22.8001571,75.8378225,17z?entry=ttu" target="_blank" rel="noreferrer" className="rounded-full bg-white h-8 w-8 inline-block mx-1 text-center pt-1">
