...
export default function NewEventCard({ news }) {
  ...
  return (
    <div className="w-full rounded-xl p-3 bg-green-300 border-2 border-tgreen hover:scale-105 transition-transform hover:bg-green-500 hover:text-gray-200">
      ...
      <div className="w-full  flex flex-col justify-center p-2">
        ...
        <button
          className="w-1/3 rounded-md p-2 bg-gray-200 text-sm outline-none text-black font-semibold duration-100 hover:text-white hover:bg-green-800"
          onClick={() => {
