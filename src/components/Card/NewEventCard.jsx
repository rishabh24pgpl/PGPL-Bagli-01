...
export default function NewEventCard({ event }) {
    ...
    return (
        <div className='w-full rounded-xl p-3 bg-bred border-2 border-tred'>
            ...
            <div className='w-full  flex flex-col justify-center p-2'>
                ...
                <button
                    className='w-1/3 rounded-md p-2 bg-tred outline-none text-white duration-100 hover:text-black ' 
