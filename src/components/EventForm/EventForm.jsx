  ...
  return (
    <>
      <div className='flex flex-col w-full justify-center items-center bg-[url("/MessageSvg.svg")]'>
        <h1 className='text-center mx-auto w-full my-3 text-4xl font-bold text-tred '>Event Details Form</h1>
        <div className='w-11/12 rounded-lg flex flex-col justify-center items-center bg-bred opacity-75 p-5'>
